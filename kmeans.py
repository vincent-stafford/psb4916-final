...
logger = logging.getLogger("Kmeans AI")
...
def main():
    ...
    for i in range(X_train.shape[0]):
        ...
        dbscan = KMeans(n_clusters=2).fit(pixels) #Remember to specify hyperparamaters
        logger.info("Starting to run Kmeans Clustering.")
