...
logger = logging.getLogger("Spectral AI")
...
def visualize_clustering_on_image(image, labels):
    ...
    ax[1].title.set_text('OPTICS Clustering')
    ax[1].axis('off')
...
def main():
    ...
    for i in range(X_train.shape[0]):
        ...
        dbscan = OPTICS().fit(pixels) #Remember to specify hyperparamaters
        logger.info("Starting to run OPTICS Clustering.")
